package com.piano.keyboard.synthesia.learnpiano.play.music.screens.record
...
import com.piano.keyboard.synthesia.learnpiano.play.music.databinding.ActivityRecordDetailBinding
import com.piano.keyboard.synthesia.learnpiano.play.music.utils.NTDOtherMyDialog
    ...
    override fun initListener() {
        ...
        binding.ivShare.setOnClickListener {
            ...
            val fileUri: Uri = FileProvider.getUriForFile(
                this@NTDViewRecordDetail,
                "com.piano.keyboard.synthesia.learnpiano.play.music.contentprovider",
                file
            )
        ...
        if (Network().isNetworkAvailable(this)) {
            try {
                Admob.getInstance().loadNativeAd(
                    this,
                    getString(R.string.native_record),
                    object : NativeCallback() {
                        override fun onNativeAdLoaded(nativeAd: NativeAd) {
                            super.onNativeAdLoaded(nativeAd)
                            val adView = LayoutInflater.from(this@NTDViewRecordDetail)
                                .inflate(R.layout.native_ads_small_above_button, null) as NativeAdView
