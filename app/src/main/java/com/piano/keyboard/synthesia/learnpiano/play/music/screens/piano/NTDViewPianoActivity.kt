...
import com.piano.keyboard.synthesia.learnpiano.play.music.piano_lib.listener.NTDOtherOnLoadAudioListener
import com.piano.keyboard.synthesia.learnpiano.play.music.piano_lib.listener.NTDOtherOnPianoAutoPlayListener
import com.piano.keyboard.synthesia.learnpiano.play.music.piano_lib.listener.NTDOtherOnPianoListener
import com.piano.keyboard.synthesia.learnpiano.play.music.piano_lib.view.NTDOtherPianoView
...
import com.piano.keyboard.synthesia.learnpiano.play.music.databinding.ActivityPianoBinding
...
import com.piano.keyboard.synthesia.learnpiano.play.music.helper.PianoPlaylist
import com.piano.keyboard.synthesia.learnpiano.play.music.model.NTDModelPianoKey
import com.piano.keyboard.synthesia.learnpiano.play.music.model.NTDPiano
import com.piano.keyboard.synthesia.learnpiano.play.music.screens.permission.NTDViewPermissionActivity
import com.piano.keyboard.synthesia.learnpiano.play.music.screens.piano.dialog.NTDOtherPianoSettingDialog
import com.piano.keyboard.synthesia.learnpiano.play.music.screens.piano.dialog.NTDOtherPlayListDialog
...
import com.piano.keyboard.synthesia.learnpiano.play.music.screens.piano.piano_style.NTDViewPianoStyleActivity
...
class NTDViewPianoActivity : NTDOtherBaseActivityAppntd<ActivityPianoBinding>(),
    ...
    private fun loadBanner() {
        if (Network().isNetworkAvailable(this)) {
            binding.rlBanner.visibility = VISIBLE
            Admob.getInstance().loadBanner(this, getString(R.string.banner_all))
        } else {
            binding.rlBanner.visibility = GONE
        }
    }

    override fun onBackPressed() {
        var count =
            NTDHelperSharePrefUtils.getInt(NTDHelperSharePrefUtils.IS_BACK_FROM_INSTRUMENT, 0)
        Log.d("uiiiiii", count.toString())
        if (!flagInit) {
            if (isRecording) {
                isBackScreen = true
