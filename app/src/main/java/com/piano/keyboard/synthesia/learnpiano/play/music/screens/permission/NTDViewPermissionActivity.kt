package com.piano.keyboard.synthesia.learnpiano.play.music.screens.permission
...
import com.piano.keyboard.synthesia.learnpiano.play.music.databinding.ActivityPermissionBinding
...
class NTDViewPermissionActivity : NTDOtherBaseActivityAppntd<ActivityPermissionBinding>(),
    ...
    private val storageActivityResultLauncher =
        (this as ComponentActivity).registerForActivityResult(ActivityResultContracts.RequestPermission()) {
            ...
            alertDialog.setButton(
                ...
                AppOpenManager.getInstance().disableAppResumeWithActivity(NTDViewPermissionActivity::class.java)
    ...
    override fun onResume() {
        super.onResume()
        enableGo()
        AppOpenManager.getInstance().enableAppResumeWithActivity(NTDViewPermissionActivity::class.java)
    }
}
