 ...
 * 钢琴键实体
 */
public class NTDOtherPianoKey {
  //类型[黑键、白键]
  private NTDOtherPiano.PianoKeyType type;
  //音乐类型[DO,RE,MI,FA,SO,LA,SI]
  private NTDOtherPiano.PianoVoice voice;
  //所属组
  private int group;
  //所属组下的位置
  ...
  public NTDOtherPiano.PianoVoice getVoice() {
    return voice;
  }

  public void setVoice(NTDOtherPiano.PianoVoice voice) {
    this.voice = voice;
  }
