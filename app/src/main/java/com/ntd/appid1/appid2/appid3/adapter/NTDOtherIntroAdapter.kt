...
class NTDOtherIntroAdapter(context: Context) : RecyclerView.Adapter<NTDOtherIntroAdapter.PageHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PageHolder {
        ...
        val itemView = layoutInflater.inflate(R.layout.item_intro, parent, false)
    ...
    inner class PageHolder(private val view: View) : ViewHolder(view) {
        ...
        init {
            ivItem.layoutParams.width = (100f * w).toInt()
        }
