...
public final class ItemIntroBinding implements ViewBinding {
  ...
  private ItemIntroBinding(@NonNull ConstraintLayout rootView, @NonNull AppCompatImageView ivItem) {
  ...
  public static ItemIntroBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemIntroBinding((ConstraintLayout) rootView, ivItem);
    }
